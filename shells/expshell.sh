...
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/solov2/a_solov2_r50_fpn_1x_coco_ResNeXt.py --work-dir ./work_dir_10_12/solov2-ResNeXt
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/solov2/a_solov2_r50_fpn_1x_coco_ResNeSt.py --work-dir ./work_dir_10_12/solov2-ResNeSt
